                        ...
                        {activeTab === 'schedule' && (
                            <div className="glass-card" style={{ padding: '3rem', textAlign: 'center', maxWidth: '700px', margin: '0 auto' }}>
                                ...
                                <p style={{ color: '#64748b', lineHeight: '1.7', marginBottom: '2.5rem', fontSize: '1.0625rem' }}>
                                    Set your available time slots for patients to book appointments. You can add, edit, or remove slots anytime.
                                </p>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
                                    {['09:00 AM', '10:00 AM', '11:00 AM', '02:00 PM', '03:00 PM', '04:00 PM'].map((time, i) => (
                                        <div key={i} className="card card-hover" style={{
                                            ...
                                            <span style={{ fontWeight: '600', fontSize: '1rem', color: '#0f172a' }}>{time}</span>
                                            <button style={{
                                                background: 'none',
                                                border: 'none',
                                                color: '#ef4444',
                                ...
                                <button className="btn btn-primary" style={{ width: '100%', fontSize: '1.0625rem', padding: '1rem' }}>
